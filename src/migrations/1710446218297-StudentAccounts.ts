...
export class StudentAccounts1710446218297 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE \`Users_Accounts\` (\`id\` int NOT NULL AUTO_INCREMENT, \`login\` varchar(32) NOT NULL, \`email\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`state\` enum ('0', '1') NOT NULL DEFAULT '1', UNIQUE INDEX \`IDX_f803275cd5649d5be61fa24b2d\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`
        );
